// ORM class for table 'current_owners'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Mon Apr 22 17:25:52 MSK 2024
...
public class current_owners extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("nft_address", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        current_owners.this.nft_address = (String)value;
      }
    });
    setters.put("token_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        current_owners.this.token_id = (String)value;
      }
    });
    setters.put("owner", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        current_owners.this.owner = (String)value;
      }
    });
  }
  public current_owners() {
    init0();
  }
  ...
  public current_owners with_nft_address(String nft_address) {
    this.nft_address = nft_address;
    return this;
  }
  ...
  public current_owners with_token_id(String token_id) {
    this.token_id = token_id;
    return this;
  }
  ...
  public current_owners with_owner(String owner) {
    this.owner = owner;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof current_owners)) {
      return false;
    }
    current_owners that = (current_owners) o;
    boolean equal = true;
    ...
    equal = equal && (this.owner == null ? that.owner == null : this.owner.equals(that.owner));
    return equal;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.owner = JdbcWritableBridge.readString(3, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(owner, 3 + __off, 12, __dbStmt);
    return 3;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.owner = Text.readString(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.owner) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, owner);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(owner==null?"null":owner, delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.owner = null; } else {
      this.owner = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    current_owners o = (current_owners) super.clone();
    return o;
  }

  public void clone0(current_owners o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("owner", this.owner);
